...
<aside id="logo-sidebar" :class="['fixed top-0 left-0 z-40 w-64 h-screen transition-transform bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700', { '-translate-x-full': !sidebarOpen }]"  v-click-outside="closeSidebar"  aria-label="Sidebar">
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bgsid dark:bg-gray-400">
     <div class="flex items-center justify-center py-4">
      ...
      <ul class="space-y-2 font-medium">
        <li>
          <a  href="/cms/dashboard2" class="flex items-center p-2 text-base font-normal text-gray-200 rounded-lg hover:bg-gray-700 hover:text-white">
            <svg class="w-6 h-6 text-gray-200 transition duration-75 group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path d="M10 3a1 1 0 011 1v1h3.25C14.664 5 15 5.336 15 5.75v9.5c0 .414-.336.75-.75.75H5.75A.75.75 0 015 15.25v-9.5C5 5.336 5.336 5 5.75 5H9V4a1 1 0 011-1zm-2 8v3h4v-3H8zm4-2V7H8v2h4z"/>
            </svg>
        ...
        <li>
          <a  href="/cms/branch" class="flex items-center p-2 text-base font-normal text-gray-200 rounded-lg hover:bg-gray-700 hover:text-white">
            <svg class="w-6 h-6 text-gray-200 transition duration-75 group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path d="M10 3a1 1 0 011 1v1h3.25C14.664 5 15 5.336 15 5.75v9.5c0 .414-.336.75-.75.75H5.75A.75.75 0 015 15.25v-9.5C5 5.336 5.336 5 5.75 5H9V4a1 1 0 011-1zm-2 8v3h4v-3H8zm4-2V7H8v2h4z"/>
            </svg>
            <span class="ml-3">จัดการสาขา</span>
          </a>
        </li>
...
<!-- <aside :class="['fixed z-30 inset-y-0 left-0 w-64 bg-gray-800 transform', { '-translate-x-full': !sidebarOpen }]" @click.away="sidebarOpen = false" >
   <div class="h-full overflow-y-auto py-4 px-3 bg-gray-800 h-screen">

      <div class="flex items-center justify-center py-4">
         <img src="https://www.iddriver.com/wp-content/uploads/2021/01/IDdriver_NoBG.png" alt="Logo" class="h-10 w-10" />
         <span class="text-white text-xl font-semibold ml-2">YourBrand</span>
      </div>

      <ul class="space-y-2 font-medium">
         <li>
            <a href="#" class="flex items-center p-2 text-base font-normal text-blue-200 rounded-lg hover:bg-gray-700 hover:text-white">
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-base font-normal text-blue-200 rounded-lg hover:bg-gray-700 hover:text-white group">
  ...
  export default {
    ...
    return {
     ...
     menuItems: [
        ...
        { id: 6, name: 'ผู้ใช้งาน', route: '/about' ,sf:'<svg class="w-6 h-6 text-gray-200 transition duration-75 group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"> <path d="M10 3a1 1 0 011 1v1h3.25C14.664 5 15 5.336 15 5.75v9.5c0 .414-.336.75-.75.75H5.75A.75.75 0 015 15.25v-9.5C5 5.336 5.336 5 5.75 5H9V4a1 1 0 011-1zm-2 8v3h4v-3H8zm4-2V7H8v2h4z"/></svg>', submenu: [
            { id: 9, name: 'ผู้ใช้งานทั้งหมด', route: '/cms/manageuser' },
            { id: 10, name: 'เพิ่มผู้ใช้งาน', route: '/cms/manageuser/create' },
          ],
        },
