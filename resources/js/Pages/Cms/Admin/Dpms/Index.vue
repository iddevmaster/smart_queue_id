...
export default {
  ...
  methods: {
    search() {
      this.$inertia.get(route("managedpms.index"), { query: this.query });
    },
    editItem(id) {
   

      this.$inertia.get(`/cms/managedpms/${id}/edit`, {
    ...
    deleteItem() {
     ...
     this.$inertia.delete(`/cms/managedpms/${this.branch_id}`, {
        onSuccess: () => {
         console.log('ok');
        },
        onError: () => {
            ...
            >
              <div class="w-full md:w-1/2 ">
                ...
                <div class="relative w-full">
                  ...
                  <span class="mb-4 text-xl font-extrabold">ฝ่ายทั้งหมด</span>
                </div>
              </div>
            ...
            >
              ...
              >
                <tr>
                  ...
                  <th scope="col" class="px-4 py-4">รหัสสาขา</th>
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="px-4 py-3">{{ org.code }}</td>
