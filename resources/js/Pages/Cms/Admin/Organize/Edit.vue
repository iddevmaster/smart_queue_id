...
<template>
  ...
  <Authenbackend>
    <div class="container mx-auto p-4 crdfr">
      <hr class="hr-text" data-content="แก้ไข" />
        ...
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
          <form @submit.prevent="submit">
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
              ...
              <div
                class="w-full sm:col-span-2 md:w-auto flex flex-col space-y-2 md:space-y-0 items-stretch justify-end md:space-x-3 flex-shrink-0"
              >
                <button
                  type="submit"
...
export default {
  ...
  methods: {
    submit() {
      this.$inertia.put(`/cms/manageorganize/${this.data.id}`, this.form, {
        onSuccess: () => {
          console.log("ok");
        },
        onError: () => {
